...
export class UsersService {
  ...
  private readonly _queryParamsChange$ = new Subject<QueryParameters>();
  ...
  setQueryParams(queryParams: QueryParameters): void {
    this._queryParamsChange$.next(queryParams);
  }
  ...
  getUsers(): Observable<PaginatedResponse<User>> {
    return this._queryParamsChange$.pipe(
      startWith({ size: 20, current: 1 }),
